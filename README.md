...
4. Just a more refined segmentation process similar to the previous one, named "**my_miccai_post_wm_30_formatting.py**". Cropping/padding is still poorly handled.
