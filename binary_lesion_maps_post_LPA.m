...
function binary_lesion_maps_post_LPA(glob_path_input,prob_threshold)
    %Requires a modified "ps_LST_thresholding.m" file to be working
    %properly with a user input threshold. Otherwise the code will just
    %assume that it is 0.5... Which in many cases is waaay to high.
    ...
    matlabbatch{1}.spm.tools.LST.thresholding.data_plm = cell_char_paths;
    matlabbatch{1}.spm.tools.LST.thresholding.bin_thresh = prob_threshold;
