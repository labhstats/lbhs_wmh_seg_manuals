...
switch outputFormat
    case 'web'
        fprintf ('CNSP_webViewSlices_overlay: Not generating webpage ...\n'); %Changed by labhracorgi.
        %web ([outputDir '/' title '.html'], '-new'); %Changed by labhracorgi.
    case 'arch'
        fprintf ('CNSP_webViewSlices_overlay: Not archiving for download ...\n'); %Changed by labhracorgi.
        %archive (outputDir, title); %Changed by labhracorgi.
    case 'web&arch'
        fprintf ('CNSP_webViewSlices_overlay: Not generating webpage ...\n'); %Changed by labhracorgi.
        %web ([outputDir '/' title '.html'], '-new'); %Changed by labhracorgi.
        fprintf ('CNSP_webViewSlices_overlay: Not archiving for download ...\n'); %Changed by labhracorgi.
